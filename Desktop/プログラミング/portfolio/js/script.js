...
type:'pie',//グラフのタイプ
data:{//グラフのデータ
	labels:["HTML","CSS","JAVA.SCRIPT","PHP",],//データの名前
	datasets:[{
			label:"言語の種類",//グラフのタイトル
...
type:'bar',//グラフのタイプ
data:{//グラフのデータ
	labels:["令和5年度","令和6年度","令和7年度",],//データの名前
	datasets:[{
			label:"売上目標",//グラフのタイトル
			backgroundColor:"#00b7b8",//グラフの色
			data:["1500","1800","2000",]//横列に並ぶデータ
		}]
},
options:{//グラフのオプション
	...
	tooltips:{//グラフへカーソルを合わせた際の詳細表示の設定
        ...
        label: function(tooltipItems, data) {
            ...
            return data.datasets[tooltipItems.datasetIndex].label + "：" + tooltipItems.yLabel + "金";//人を最後につける
        }
    }
	},
title:{//上部タイトル表示の設定
